...
class LogicInferenceEngine:
    ...
    def load_logic_programs(self):
        with open(os.path.join('../outputs/logic_programs', f'{self.dataset_name}_{self.split}.json')) as f:
            dataset = json.load(f)
    ...
    def save_results(self, outputs):
        ...
        with open(os.path.join(self.save_path, f'{self.dataset_name}_{self.split}_backup-{self.backup_strategy}.json'), 'w') as f:
